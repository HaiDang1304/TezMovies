...
const MovieCategrory = () => {
    const [movies, setMovies] = useState([]);

    useEffect(() => {
        axios
            .get("https://phimapi.com/v1/api/the-loai/hanh-dong?page=1&limit=50")
            .then((res) => {
                            ...
                            <Link to={`/phim/${movie.slug}`}>
                                <div className="bg-gray-800 rounded-xl overflow-hidden shadow hover:shadow-xl transition duration-300 group">
                                    <div className="relative transition-all duration-300">
                                        ...
                                        <div className="absolute bottom-20 flex w-full items-center justify-center text-center">
