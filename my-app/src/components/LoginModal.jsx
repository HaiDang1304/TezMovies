...
export default function LoginModal({ isOpen, onClose }) {
    ...
    return (
        ...
        bg-gradient-to-br from-[#1E1E3F] to-[#2A2A4A] rounded-2xl w-full max-w-[480px] sm:max-w-[640px] lg:max-w-[800px] mx-4
            ...
            >
                ...
                <div className="flex-1 p-6 sm:p-8 flex flex-col text-white">
                    ...
                    <p className="text-sm sm:text-base text-gray-300 mb-6">
                        ...
                        <a
                            href="#"
                            className="text-[#FFD369] underline hover:text-yellow-300 transition-colors duration-200"
                        >
                            đăng ký ngay
                        </a>
                    </p>
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-3 bg-white text-gray-900 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-200 w-full shadow-md hover:shadow-lg"
                    >
