  ...
  return (
    <div className="flex min-h-screen bg-gray-900 text-white py-10 mt-10 px-8 ">
      ...
      <aside className="min-w-[300px] bg-gray-800 p-6 flex flex-col rounded-3xl mt-4 mr-6">
        <h2 className="text-xl font-medium mb-6 items-center justify-center">Quản lý tài khoản</h2>
        <nav className="flex flex-col gap-3">
          ...
          >
            <div className="flex items-center p-2 gap-2">
              ...
              <div className="text-md font-medium">Yêu thích</div>
            </div>
          </NavLink>
          <NavLink
            to="lists"
          ...
          >
            <div className="flex items-center p-2 gap-2">
              ...
              <div className="text-md font-medium">Danh sách</div>
            </div>
          </NavLink>
          <NavLink
            to="watch-later"
          ...
          >
            <div className="flex items-center p-2 gap-2">
              ...
              <div className="text-md font-medium">Xem tiếp</div>
            </div>
          </NavLink>
          <NavLink
            to="profile"
          ...
          >
            <div className="flex items-center p-2 gap-2">
              ...
              <div className="text-md font-medium">Tài khoản</div>
            </div>
          </NavLink>
        </nav>
      </aside>
